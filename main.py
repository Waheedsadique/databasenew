...
@app.post("/create_referrals" , response_model=Referral)
...
@app.get("/single_withdrawals/{withdrawal_id}" , response_model=WithdrawalRead)
...
@app.delete("/delete_withdrawals/{withdrawal_id}")
